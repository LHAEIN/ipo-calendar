const companies = [
  ...
  },
  {
    ...
    price: '12,000원', priceBand: '10,000~12,000원', broker: '대신증권', refund: '2026.09.17',
    offering: '1,600,000주 · 신주모집 100%',
    summary: '상품과 브랜드를 직접 기획하고 마케팅·유통·고객관리까지 수행하는 브랜드 빌더입니다.',
    demand: { status: 'done', text: '기관 경쟁률 1,248.47 : 1 · 의무보유확약 3.65% · 확정 공모가 12,000원' },
    sources: [
      ['수요예측 세부 결과', 'https://www.38.co.kr/html/fund/?l=&no=2311&o=v&page=1'],
      ['DART 공시', 'https://dart.fss.or.kr/']
    ]
  },
  {
    id: 'bigwave-robotics', name: '빅웨이브로보틱스', type: '일반', subscription: ['2026-09-15', '2026-09-16'], listing: '2026-09-29',
    price: '18,000원', priceBand: '15,000~18,000원', broker: '유진투자증권 · 미래에셋증권', refund: '2026.09.18',
    summary: '로봇 자동화 플랫폼 마로솔과 AI 오케스트레이션 플랫폼 솔링크를 운영하는 피지컬 AI 기업입니다.',
    demand: { status: 'done', text: '기관 경쟁률 1,109.37 : 1 · 의무보유확약 18.14% · 확정 공모가 18,000원' },
    sources: [['수요예측 결과 및 일정', 'https://www.38.co.kr/html/fund/?no=2294&o=v']]
  },
  {
    id: 'deoksan-nepcores', name: '덕산넵코어스', type: '일반', subscription: ['2026-09-16', '2026-09-17'], listing: '2026-09-30',
    price: '14,600원', priceBand: '12,400~14,600원', broker: '대신증권', refund: '2026.09.21',
    summary: '설계부터 생산·시험까지 제공하는 특수 목적용 항재밍 토탈 솔루션 기업입니다.',
    demand: { status: 'done', text: '기관 경쟁률 868.64 : 1 · 의무보유확약 4.05% · 확정 공모가 14,600원' },
    sources: [['수요예측 세부 결과', 'https://v.daum.net/v/20260915153830707'], ['상장 예정일', 'https://www.hankyung.com/article/2026091429936']]
  },
  {
    id: 'global-technology', name: '글로벌테크놀로지', type: '일반', subscription: ['2026-09-16', '2026-09-17'], listing: '2026-09-29',
    price: '10,000원', priceBand: '13,000~15,000원', broker: '한국투자증권', refund: '2026.09.21',
    summary: 'LED 구동반도체를 주력으로 개발하는 시스템 반도체 팹리스 기업입니다.',
    demand: { status: 'done', text: '기관 경쟁률 123.19 : 1 · 의무보유확약 0.27% · 확정 공모가 10,000원' },
    sources: [['공모가·기관 경쟁률 발표', 'https://www.newspim.com/news/view/20260915001123'], ['수요예측 세부 정보', 'https://www.38.co.kr/html/fund/?o=k']]
  },
  {
    id: 'brils', name: '브릴스', type: '일반', subscription: ['2026-09-17', '2026-09-18'], listing: '2026-10-01',
    price: '19,500원', priceBand: '16,500~19,500원', broker: 'IBK투자증권', refund: '2026.09.22',
    summary: '설계·소프트웨어·생산·설치·사후관리 전 과정을 제공하는 로봇 모듈화 플랫폼 기업입니다.',
    demand: { status: 'done', text: '기관 경쟁률 1,187.74 : 1 · 의무보유확약 21.75% · 확정 공모가 19,500원' },
